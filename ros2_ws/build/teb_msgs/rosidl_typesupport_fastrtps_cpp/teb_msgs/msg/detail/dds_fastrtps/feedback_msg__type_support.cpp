...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_TrajectoryMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_ObstacleArrayMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: trajectories
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      teb_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.trajectories[i],
        cdr);
    }
  }
  ...
  // Member: obstacles_msg
  costmap_converter_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
    ros_message.obstacles_msg,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: trajectories
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        teb_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.trajectories[index], current_alignment);
    }
  }
  ...
  // Member: obstacles_msg
  current_alignment +=
    costmap_converter_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
    ros_message.obstacles_msg, current_alignment);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_teb_msgs
max_serialized_size_key_FeedbackMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: trajectories
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        teb_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_TrajectoryMsg(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: obstacles_msg
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        costmap_converter_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_ObstacleArrayMsg(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
