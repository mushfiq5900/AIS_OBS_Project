...
teb_msgs__msg__TrajectoryMsg__get_type_hash(
...
static char teb_msgs__msg__TrajectoryMsg__FIELD_NAME__header[] = "header";
static char teb_msgs__msg__TrajectoryMsg__FIELD_NAME__trajectory[] = "trajectory";

static rosidl_runtime_c__type_description__Field teb_msgs__msg__TrajectoryMsg__FIELDS[] = {
  {
    {teb_msgs__msg__TrajectoryMsg__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {teb_msgs__msg__TrajectoryMsg__FIELD_NAME__trajectory, 10, 10},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription teb_msgs__msg__TrajectoryMsg__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
teb_msgs__msg__TrajectoryMsg__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {teb_msgs__msg__TrajectoryMsg__FIELDS, 2, 2},
    },
    {teb_msgs__msg__TrajectoryMsg__REFERENCED_TYPE_DESCRIPTIONS, 9, 9},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[8].fields = teb_msgs__msg__TrajectoryPointMsg__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
static char toplevel_type_raw_source[] =
  ...
  "teb_msgs/TrajectoryPointMsg[] trajectory\n"
  "\n"
  "";
...
teb_msgs__msg__TrajectoryMsg__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
...
teb_msgs__msg__TrajectoryMsg__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *teb_msgs__msg__TrajectoryMsg__get_individual_type_description_source(NULL),
    ...
    sources[9] = *teb_msgs__msg__TrajectoryPointMsg__get_individual_type_description_source(NULL);
    constructed = true;
  }
