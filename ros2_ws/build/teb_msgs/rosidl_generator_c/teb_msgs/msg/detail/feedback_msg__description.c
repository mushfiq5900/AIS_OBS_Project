...
teb_msgs__msg__FeedbackMsg__get_type_hash(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static rosidl_type_hash_t hash = {1, {
      0x03, 0x2d, 0x42, 0xa0, 0x52, 0xd8, 0xea, 0xf4,
      0x33, 0x03, 0x03, 0x1a, 0xc9, 0xd6, 0xaa, 0x7e,
      0xe0, 0xbd, 0x8e, 0x89, 0xd7, 0x7c, 0x6b, 0xe0,
      0xb7, 0xde, 0x71, 0x26, 0xee, 0x4b, 0xb2, 0xa6,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t costmap_converter_msgs__msg__ObstacleArrayMsg__EXPECTED_HASH = {1, {
...
static const rosidl_type_hash_t teb_msgs__msg__TrajectoryMsg__EXPECTED_HASH = {1, {
    0x06, 0x02, 0xf8, 0xf6, 0xdf, 0xd7, 0x6e, 0x85,
    0x2d, 0xb7, 0x37, 0xde, 0xa8, 0x93, 0xec, 0x4b,
    0x37, 0xaa, 0xee, 0xdf, 0xbd, 0xe9, 0x30, 0xa3,
    0x41, 0xd0, 0x5c, 0xfd, 0x84, 0xe0, 0xdf, 0xb1,
  }};
static const rosidl_type_hash_t teb_msgs__msg__TrajectoryPointMsg__EXPECTED_HASH = {1, {
    0x6f, 0x7a, 0xa5, 0xb2, 0x5f, 0xcf, 0xda, 0x62,
    0x3b, 0x5e, 0xe6, 0xbb, 0x45, 0x2c, 0xc6, 0xb8,
    0xf5, 0xcc, 0x2c, 0x40, 0xcf, 0x66, 0x59, 0xf2,
    0x5d, 0x6a, 0x3b, 0x86, 0x68, 0xfd, 0x0e, 0x10,
  }};
#endif

static char teb_msgs__msg__FeedbackMsg__TYPE_NAME[] = "teb_msgs/msg/FeedbackMsg";
...
static char teb_msgs__msg__TrajectoryMsg__TYPE_NAME[] = "teb_msgs/msg/TrajectoryMsg";
static char teb_msgs__msg__TrajectoryPointMsg__TYPE_NAME[] = "teb_msgs/msg/TrajectoryPointMsg";

// Define type names, field names, and default values
static char teb_msgs__msg__FeedbackMsg__FIELD_NAME__header[] = "header";
static char teb_msgs__msg__FeedbackMsg__FIELD_NAME__trajectories[] = "trajectories";
static char teb_msgs__msg__FeedbackMsg__FIELD_NAME__selected_trajectory_idx[] = "selected_trajectory_idx";
static char teb_msgs__msg__FeedbackMsg__FIELD_NAME__obstacles_msg[] = "obstacles_msg";

static rosidl_runtime_c__type_description__Field teb_msgs__msg__FeedbackMsg__FIELDS[] = {
  {
    {teb_msgs__msg__FeedbackMsg__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {teb_msgs__msg__FeedbackMsg__FIELD_NAME__trajectories, 12, 12},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
      {teb_msgs__msg__TrajectoryMsg__TYPE_NAME, 26, 26},
    },
    {NULL, 0, 0},
  },
  {
    {teb_msgs__msg__FeedbackMsg__FIELD_NAME__selected_trajectory_idx, 23, 23},
    {
  ...
  {
    {teb_msgs__msg__FeedbackMsg__FIELD_NAME__obstacles_msg, 13, 13},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription teb_msgs__msg__FeedbackMsg__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  {
    {teb_msgs__msg__TrajectoryPointMsg__TYPE_NAME, 31, 31},
    {NULL, 0, 0},
  },
};

const rosidl_runtime_c__type_description__TypeDescription *
teb_msgs__msg__FeedbackMsg__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {teb_msgs__msg__FeedbackMsg__TYPE_NAME, 24, 24},
      {teb_msgs__msg__FeedbackMsg__FIELDS, 4, 4},
    },
    {teb_msgs__msg__FeedbackMsg__REFERENCED_TYPE_DESCRIPTIONS, 15, 15},
  };
  if (!constructed) {
    ...
    assert(0 == memcmp(&costmap_converter_msgs__msg__ObstacleArrayMsg__EXPECTED_HASH, costmap_converter_msgs__msg__ObstacleArrayMsg__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[2].fields = costmap_converter_msgs__msg__ObstacleArrayMsg__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[3].fields = costmap_converter_msgs__msg__ObstacleMsg__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[5].fields = geometry_msgs__msg__Point32__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[6].fields = geometry_msgs__msg__Polygon__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[10].fields = geometry_msgs__msg__TwistWithCovariance__get_type_description(NULL)->type_description.fields;
    ...
    assert(0 == memcmp(&teb_msgs__msg__TrajectoryMsg__EXPECTED_HASH, teb_msgs__msg__TrajectoryMsg__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[13].fields = teb_msgs__msg__TrajectoryMsg__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&teb_msgs__msg__TrajectoryPointMsg__EXPECTED_HASH, teb_msgs__msg__TrajectoryPointMsg__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[14].fields = teb_msgs__msg__TrajectoryPointMsg__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
teb_msgs__msg__FeedbackMsg__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
...
teb_msgs__msg__FeedbackMsg__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *teb_msgs__msg__FeedbackMsg__get_individual_type_description_source(NULL),
    sources[1] = *builtin_interfaces__msg__Duration__get_individual_type_description_source(NULL);
    sources[2] = *builtin_interfaces__msg__Time__get_individual_type_description_source(NULL);
    sources[3] = *costmap_converter_msgs__msg__ObstacleArrayMsg__get_individual_type_description_source(NULL);
    sources[4] = *costmap_converter_msgs__msg__ObstacleMsg__get_individual_type_description_source(NULL);
    sources[5] = *geometry_msgs__msg__Point__get_individual_type_description_source(NULL);
    sources[6] = *geometry_msgs__msg__Point32__get_individual_type_description_source(NULL);
    sources[7] = *geometry_msgs__msg__Polygon__get_individual_type_description_source(NULL);
    ...
    sources[11] = *geometry_msgs__msg__TwistWithCovariance__get_individual_type_description_source(NULL);
    ...
    sources[14] = *teb_msgs__msg__TrajectoryMsg__get_individual_type_description_source(NULL);
    sources[15] = *teb_msgs__msg__TrajectoryPointMsg__get_individual_type_description_source(NULL);
    constructed = true;
  }
