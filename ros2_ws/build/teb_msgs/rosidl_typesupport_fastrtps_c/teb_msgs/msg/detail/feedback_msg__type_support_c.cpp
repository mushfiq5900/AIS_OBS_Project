...
bool cdr_serialize_costmap_converter_msgs__msg__ObstacleArrayMsg(
  const costmap_converter_msgs__msg__ObstacleArrayMsg * ros_message,
  eprosima::fastcdr::Cdr & cdr);

ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_teb_msgs
bool cdr_deserialize_costmap_converter_msgs__msg__ObstacleArrayMsg(
  eprosima::fastcdr::Cdr & cdr,
  costmap_converter_msgs__msg__ObstacleArrayMsg * ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_teb_msgs
bool cdr_serialize_key_costmap_converter_msgs__msg__ObstacleArrayMsg(
  const costmap_converter_msgs__msg__ObstacleArrayMsg * ros_message,
  eprosima::fastcdr::Cdr & cdr);

ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_teb_msgs
size_t get_serialized_size_key_costmap_converter_msgs__msg__ObstacleArrayMsg(
  const void * untyped_ros_message,
  size_t current_alignment);

ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_teb_msgs
size_t max_serialized_size_key_costmap_converter_msgs__msg__ObstacleArrayMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_teb_msgs__msg__TrajectoryMsg(
  const teb_msgs__msg__TrajectoryMsg * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_teb_msgs__msg__TrajectoryMsg(
  eprosima::fastcdr::Cdr & cdr,
  teb_msgs__msg__TrajectoryMsg * ros_message);
...
bool cdr_serialize_key_teb_msgs__msg__TrajectoryMsg(
  const teb_msgs__msg__TrajectoryMsg * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_teb_msgs__msg__TrajectoryMsg(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_teb_msgs__msg__TrajectoryMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_teb_msgs__msg__FeedbackMsg(
  const teb_msgs__msg__FeedbackMsg * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: trajectories
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_teb_msgs__msg__TrajectoryMsg(
        &array_ptr[i], cdr);
    }
  }
  ...
  {
    cdr_serialize_costmap_converter_msgs__msg__ObstacleArrayMsg(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_teb_msgs
bool cdr_deserialize_teb_msgs__msg__FeedbackMsg(
  eprosima::fastcdr::Cdr & cdr,
  teb_msgs__msg__FeedbackMsg * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: trajectories
  {
    ...
    auto array_ptr = ros_message->trajectories.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_teb_msgs__msg__TrajectoryMsg(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: obstacles_msg
  {
    cdr_deserialize_costmap_converter_msgs__msg__ObstacleArrayMsg(cdr, &ros_message->obstacles_msg);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_teb_msgs
bool cdr_serialize_key_teb_msgs__msg__FeedbackMsg(
  const teb_msgs__msg__FeedbackMsg * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  ...
  // Field name: trajectories
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_teb_msgs__msg__TrajectoryMsg(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: obstacles_msg
  {
    cdr_serialize_key_costmap_converter_msgs__msg__ObstacleArrayMsg(
      &ros_message->obstacles_msg, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_teb_msgs
size_t get_serialized_size_key_teb_msgs__msg__FeedbackMsg(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FeedbackMsg__ros_msg_type * ros_message = static_cast<const _FeedbackMsg__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: trajectories
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_teb_msgs__msg__TrajectoryMsg(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: obstacles_msg
  current_alignment += get_serialized_size_key_costmap_converter_msgs__msg__ObstacleArrayMsg(
    &(ros_message->obstacles_msg), current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_teb_msgs
size_t max_serialized_size_key_teb_msgs__msg__FeedbackMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: trajectories
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_teb_msgs__msg__TrajectoryMsg(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: obstacles_msg
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_costmap_converter_msgs__msg__ObstacleArrayMsg(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const teb_msgs__msg__FeedbackMsg * ros_message = static_cast<const teb_msgs__msg__FeedbackMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_teb_msgs__msg__FeedbackMsg(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  teb_msgs__msg__FeedbackMsg * ros_message = static_cast<teb_msgs__msg__FeedbackMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_teb_msgs__msg__FeedbackMsg(cdr, ros_message);
}
