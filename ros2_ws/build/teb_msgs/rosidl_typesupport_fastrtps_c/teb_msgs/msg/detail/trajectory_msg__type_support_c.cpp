...
bool cdr_serialize_teb_msgs__msg__TrajectoryPointMsg(
  const teb_msgs__msg__TrajectoryPointMsg * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_teb_msgs__msg__TrajectoryPointMsg(
  eprosima::fastcdr::Cdr & cdr,
  teb_msgs__msg__TrajectoryPointMsg * ros_message);
...
bool cdr_serialize_key_teb_msgs__msg__TrajectoryPointMsg(
  const teb_msgs__msg__TrajectoryPointMsg * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_teb_msgs__msg__TrajectoryPointMsg(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_teb_msgs__msg__TrajectoryPointMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: trajectory
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_teb_msgs__msg__TrajectoryPointMsg(
        &array_ptr[i], cdr);
    }
  }
  ...
  teb_msgs__msg__TrajectoryMsg * ros_message)
{
  ...
  // Field name: trajectory
  {
    ...
    auto array_ptr = ros_message->trajectory.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_teb_msgs__msg__TrajectoryPointMsg(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: trajectory
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_teb_msgs__msg__TrajectoryPointMsg(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: trajectory
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_teb_msgs__msg__TrajectoryPointMsg(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: trajectory
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_teb_msgs__msg__TrajectoryPointMsg(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const teb_msgs__msg__TrajectoryMsg * ros_message = static_cast<const teb_msgs__msg__TrajectoryMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_teb_msgs__msg__TrajectoryMsg(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  teb_msgs__msg__TrajectoryMsg * ros_message = static_cast<teb_msgs__msg__TrajectoryMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_teb_msgs__msg__TrajectoryMsg(cdr, ros_message);
}
