  ...
  teb_msgs__msg__TrajectoryPointMsg * ros_message)
{
  ...
  // Field name: acceleration
  {
    cdr_deserialize_geometry_msgs__msg__Twist(cdr, &ros_message->acceleration);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const teb_msgs__msg__TrajectoryPointMsg * ros_message = static_cast<const teb_msgs__msg__TrajectoryPointMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_teb_msgs__msg__TrajectoryPointMsg(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  teb_msgs__msg__TrajectoryPointMsg * ros_message = static_cast<teb_msgs__msg__TrajectoryPointMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_teb_msgs__msg__TrajectoryPointMsg(cdr, ros_message);
}
