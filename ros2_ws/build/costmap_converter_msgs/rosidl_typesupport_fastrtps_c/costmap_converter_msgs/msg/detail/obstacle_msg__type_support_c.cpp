  ...
  costmap_converter_msgs__msg__ObstacleMsg * ros_message)
{
  ...
  // Field name: velocities
  {
    cdr_deserialize_geometry_msgs__msg__TwistWithCovariance(cdr, &ros_message->velocities);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const costmap_converter_msgs__msg__ObstacleMsg * ros_message = static_cast<const costmap_converter_msgs__msg__ObstacleMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_costmap_converter_msgs__msg__ObstacleMsg(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  costmap_converter_msgs__msg__ObstacleMsg * ros_message = static_cast<costmap_converter_msgs__msg__ObstacleMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_costmap_converter_msgs__msg__ObstacleMsg(cdr, ros_message);
}
