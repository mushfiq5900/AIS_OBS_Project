...
costmap_converter_msgs__msg__ObstacleMsg__get_type_hash(
...
static char costmap_converter_msgs__msg__ObstacleMsg__FIELD_NAME__header[] = "header";
static char costmap_converter_msgs__msg__ObstacleMsg__FIELD_NAME__polygon[] = "polygon";
static char costmap_converter_msgs__msg__ObstacleMsg__FIELD_NAME__radius[] = "radius";
static char costmap_converter_msgs__msg__ObstacleMsg__FIELD_NAME__id[] = "id";
static char costmap_converter_msgs__msg__ObstacleMsg__FIELD_NAME__orientation[] = "orientation";
static char costmap_converter_msgs__msg__ObstacleMsg__FIELD_NAME__velocities[] = "velocities";

static rosidl_runtime_c__type_description__Field costmap_converter_msgs__msg__ObstacleMsg__FIELDS[] = {
  {
    {costmap_converter_msgs__msg__ObstacleMsg__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {costmap_converter_msgs__msg__ObstacleMsg__FIELD_NAME__polygon, 7, 7},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {costmap_converter_msgs__msg__ObstacleMsg__FIELD_NAME__radius, 6, 6},
    {
  ...
  {
    {costmap_converter_msgs__msg__ObstacleMsg__FIELD_NAME__id, 2, 2},
    {
  ...
  {
    {costmap_converter_msgs__msg__ObstacleMsg__FIELD_NAME__orientation, 11, 11},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {costmap_converter_msgs__msg__ObstacleMsg__FIELD_NAME__velocities, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription costmap_converter_msgs__msg__ObstacleMsg__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
costmap_converter_msgs__msg__ObstacleMsg__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {costmap_converter_msgs__msg__ObstacleMsg__FIELDS, 6, 6},
    },
    {costmap_converter_msgs__msg__ObstacleMsg__REFERENCED_TYPE_DESCRIPTIONS, 8, 8},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[5].fields = geometry_msgs__msg__TwistWithCovariance__get_type_description(NULL)->type_description.fields;
...
costmap_converter_msgs__msg__ObstacleMsg__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
...
costmap_converter_msgs__msg__ObstacleMsg__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *costmap_converter_msgs__msg__ObstacleMsg__get_individual_type_description_source(NULL),
    ...
    sources[6] = *geometry_msgs__msg__TwistWithCovariance__get_individual_type_description_source(NULL);
